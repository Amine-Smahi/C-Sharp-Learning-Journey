...
namespace FacturationMiniProjet.Facture
{
  ...
  public partial class FacturePage : Page
  {
    ...
    {
      msh.LoadData(
        "SELECT * FROM `facture`, `article`,`details`,`Client` Where facture.N_Fact = details.N_Fact and article.N_Article = details.N_Article and facture.N_Client = client.N_Client and details.HT > " +
        inputRecherche.Text + "",
        dataGridView3);
    }
    ...
    {
      FactureAdvPage af = new FactureAdvPage("");
